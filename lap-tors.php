...
include"header.php";
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">TORs (Terms of Reference) of LAP</h6>
                        </div>
                        <div class="card-body">
...
This assessment will be conducted by district coordinator of Foundation in consultation with the school's
management.
<br><br>
...
Foundation Core committee will review the request and, if approved, will provide required learning aids
to the school to promote quality education.<br><br>
<h6 class="m-0 font-weight-bold text-primary">Monitoring and Evaluation:</h6>
Foundation may conduct evaluation visits to ensure that the Learning Aids are progressing as planned
