...
?>)</div>
        ...
        echo 'NGN.' .$row_amountsum['SUM( amount)'];?></div>
                                        </div>
                                        <div class="col-auto">
...
?>)</div>
        ...
        $row_amountsum = mysqli_fetch_assoc($amountsum);
        $totalRows_amountsum = mysqli_num_rows($amountsum);
        echo 'NGN.' .$row_amountsum['SUM( approved_amount)'];?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
...
?>)</div>
        ...
        $row_amountsum = mysqli_fetch_assoc($amountsum);
        $totalRows_amountsum = mysqli_num_rows($amountsum);
        echo 'NGN.' .$row_amountsum['SUM( expected_amount)'];?></div>
                                        </div>
                                        <div class="col-auto">
    ...
    echo "$query->num_rows";?> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Introduction of Foundation</h6>
                        </div>
                        <div class="card-body">
                           The Foundation is a non-profit organization that is dedicated to providing support and resources
to schools (Especially PEF Partners) in Nigeria. The organization was founded with the aim of creating a
positive impact on the education system of the country by enhancing the quality of education in schools.
The Foundation is funded by its 200 members, who each donate 2000 Naira every month.The Foundation is an organization that is dedicated to improving the quality of education in Pakistan by providing schools with the necessary resources to create a safe and conducive learning
environment. The organizations unique model, which divides its budget into three key areas, has
proven to be effective in achieving its goals. With the support of its members, The Foundation
hopes to continue making a positive impact on the education system of Pakistan.<br><br> 
<h6 class="m-0 font-weight-bold text-primary">Download Intro & Budget Document of Foundation</h6><br>
<p><a href="Budget-Document-of-The-Education-Initative-for-FY-2023-2024.pdf" target="_blank" class="btn btn-success btn-icon-split">
                                        ...
                                        <span class="text">Complete Intro of Foundation</span>
                                    </a></p>
<h6 class="m-0 font-weight-bold text-primary">Download Intro & Budget Document of Foundation (Programs)</h6>
<div class="my-2"></div>
